...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-09-2021 a las 21:26:49
...
--
-- Indices de la tabla `ingreso_lavado`
--
ALTER TABLE `ingreso_lavado`
  ADD UNIQUE KEY `placa` (`placa`);
...
--
-- Indices de la tabla `temporal_ingreso`
--
ALTER TABLE `temporal_ingreso`
  ADD UNIQUE KEY `placa` (`placa`);
