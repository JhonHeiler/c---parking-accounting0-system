...
namespace colores
{
    public partial class impresion_empleado : Form
    {
        ...
        private void impresion_empleado_Load(object sender, EventArgs e)
        {
            string contador;
            ...
            if (myReader.Read())
            {
                contador = myReader.GetValue(0).ToString();

            }

            lblcedula.Text = liquidar_encargado.identificacion.ToString();
            lblemplea.Text = liquidar_encargado.nombre;
            lblcajero.Text = Form1.variable;
            lblfecha.Text = DateTime.Now.ToString("dd/MM/yyyy");
            lblhora.Text = DateTime.Now.ToString("HH:mm:ss");
            lblprestamo.Text = liquidar_encargado.valor.ToString();
            label12.Text = "Pago de empleado";
