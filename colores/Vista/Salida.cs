    ...
    public partial class Salida : Form
    {
        ...
        private void btncobrar_Click(object sender, EventArgs e)
        {
                    ...
                    
               {
                ...
                try
                {
                    ...
                    ingresoventas iv = new ingresoventas();
                    iv.Registrar_venta(Convert.ToInt32(lblcontador.Text), Convert.ToDateTime(dateTimePicker1.Value.Date), lblhorasalida.Text, txtplaca.Text, 0, vehiculo, "", lblparque.Text, "Invitado",
        ...
        private void btnactivar_Click(object sender, EventArgs e)
        {
            ...
            if (myRead.Read())
            {
                ...
                lblhoraentrada.Text = myRead.GetValue(1).ToString();
                ...
                fechaentrada = myRead.GetValue(0).ToString();
                ...
                //dias = span.Days;
                valorpendiente = myRead.GetValue(6).ToString();
            ...
            if (myReader.Read())
            {
                ...
                lbltiempoacobrar.Visible = true;
                lblfecha.Visible = true;
                lblhoraentrada.Text = myReader.GetValue(1).ToString();
                ...
                //lbltipo.Text = myReader.GetString(3);
                fechaentrada = myReader.GetDateTime(0).ToString();
                //MessageBox.Show(Convert.ToString(vehiculo), "alerta", MessageBoxButtons.OK, MessageBoxIcon.Information);
                //verificamos el precio por tipo de vehiculo y lo guardamos en la variable precio
                precioporhora pph = new precioporhora();
