...
namespace colores
{
    public partial class lavado : Form
    {
        ...
        private void btnconfirmar_Click(object sender, EventArgs e)
        {
            ...
            if (myReader.Read())
            {
                lblplaca.Text = myReader.GetValue(0).ToString();
                lblencargado.Text = myReader.GetValue(1).ToString();
                lblIdentificacion.Text = myReader.GetValue(2).ToString();
                lbltipo.Text = myReader.GetValue(3).ToString();
                txttotal.Text = myReader.GetValue(5).ToString();               
        ...
        private void btncobrar_Click_1(object sender, EventArgs e)
        {
           ...
           if (Convert.ToDouble(lblIdentificacion.Text) == 1082)
                {
                    try
                    {
