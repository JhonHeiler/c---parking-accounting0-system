    ...
    public partial class liquidar_encargado : Form
    {
        ...
        private void btnbuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (My.Read())
                {
                    lbltotalventas.Text = Convert.ToString(My.GetValue(0).ToString());
                }
        ...
        private void btbbuscarp_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Moy.Read())
                {
                    ...
                    SqlCommand ejecutarSQL = new SqlCommand(buscar, conexion.AbrirBD());
                    ejecutarSQL.ExecuteNonQuery();
                    DataTable dta = new DataTable();
                    SqlDataAdapter da = new SqlDataAdapter(ejecutarSQL);
                    da.Fill(dta);
        ...
        public DataTable llenar_datagridprestamo()
        {
            ...
            SqlCommand ejecutarSQL = new SqlCommand(consulta, conexion.AbrirBD());
            SqlDataAdapter jhon = new SqlDataAdapter(ejecutarSQL);
